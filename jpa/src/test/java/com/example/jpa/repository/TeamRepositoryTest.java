...
public class TeamRepositoryTest {
    ...
    public void insertTest3() {
        ...
        Team team = Team.builder().teamName("미국").build();

        TeamMember member = TeamMember.builder().userName("Klaa").team(team).build();
    ...
    public void deleteTest2() {
        // 부모 삭제시 참조중이던 자식 모두가 같이 삭제됨(내부적으로는 자식 먼저 삭제 후 부모 삭제)
